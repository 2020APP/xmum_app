...
import com.example.xmum_app.db.DatabaseBean;
...
public class CityManagerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ListView cityLv;
    List<DatabaseBean>mDatas;//show the list of data source
...
//        adapter
    ...
    /*gain the real data source in database, add to original data source, remind adapter to update*/
    @Override
        ...
        switch (v.getId()) {
            case R.id.city_iv_add:
                ...
                if (cityCount<5) {
                    ...
                    Toast.makeText(this,"the number of city is up to limitation,please delete some to add more",Toast.LENGTH_SHORT).show();
                }
                break;
